...
## Features
- **User Authentication**: Secure sign-up and log-in functionality to manage user accounts.
- **Image Upload**: Users can upload images for accommodations to enhance listings.
- **Accommodation Listings**: Browse various accommodations with filters for location, price, and amenities.
...
1. Clone the repo:
   ```sh
   git clone https://github.com/<owner>/Wanderlustt.git
